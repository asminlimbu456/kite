<template>
    <div class="w-full h-full">
        ...
        <header ref="menuRef"
            class="flex flex-wrap md:flex-nowrap w-full py-2 md:py-5 border-0 bg-yellow-900 border-neutral-200 md:relative md:h-20 md:z-10">
            <div class="flex items-center justify-start h-full max-w-[1536px] w-full px-4 md:px-10">
                ...
                <!-- <SfButton
                    class="hidden md:flex text-white font-body bg-transparent hover:bg-primary-800 hover:text-white active:bg-yellow-900 active:text-white"
                    type="button" :aria-haspopup="true" :aria-expanded="isOpen" variant="tertiary" square @click="toggle()">
                    <template #suffix>
                    ...
                    <Button class="hidden md:flex text-white font-body bg-transparent hover:bg-red-600 hover:text-white active:bg-yellow-900 active:text-white py-2 px-3 ">
                        <a href="#">Home</a>
                    </Button>
                    <Button class="hidden md:flex text-white font-body bg-transparent hover:bg-red-600 hover:text-white active:bg-yellow-900 active:text-white py-2 px-3 ">
                            <a href="#">API</a>
